...
public class PeriodoDeTrabajo {
    ...
    public PeriodoDeTrabajo(LocalDateTime inicio, LocalDateTime fin) {
        if (inicio == null) throw new IllegalArgumentException("El inicio del trabajo es obligatorio");
    ...
    public PeriodoDeTrabajo finalizar(LocalDateTime fin) { return new PeriodoDeTrabajo(inicio, fin); }
