...
public class ManejadorGlobalDeErrores {
    ...
    public ResponseEntity<Map<String, Object>> manejarFeign(FeignException exception, HttpServletRequest request) {
        return respuesta(HttpStatus.BAD_GATEWAY, "No se pudo validar el usuario tecnico", request.getRequestURI());
    }
