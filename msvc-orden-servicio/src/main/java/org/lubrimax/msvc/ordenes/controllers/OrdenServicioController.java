...
public class OrdenServicioController {
    ...
    public ResponseEntity<?> crear(@Valid @RequestBody OrdenServicio orden, BindingResult result) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of("mensaje", "No existe el cliente o vehículo indicado"));
    ...
    public ResponseEntity<?> agregarPropuesta(@PathVariable Long ordenId, @Valid @RequestBody PropuestaTecnica propuesta,
    ...
    public ResponseEntity<?> presentarPropuesta(@PathVariable Long ordenId, @PathVariable Long propuestaId) {
        return ejecutar(() -> service.presentarPropuesta(ordenId, propuestaId), HttpStatus.OK);
    }

    @PostMapping("/{ordenId}/autorizaciones")
    public ResponseEntity<?> autorizar(@PathVariable Long ordenId, @Valid @RequestBody Autorizacion autorizacion,
                                        BindingResult result) {
        if (result.hasErrors()) return validar(result);
