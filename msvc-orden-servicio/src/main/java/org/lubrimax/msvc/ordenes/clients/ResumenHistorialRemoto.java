...
public class ResumenHistorialRemoto {
    ...
    public ProximoServicioRemoto getProximoServicio() { return proximoServicio; }
    public void setProximoServicio(ProximoServicioRemoto proximoServicio) { this.proximoServicio = proximoServicio; }
}
