...
public class ProximoServicioRemoto {
    ...
    public void setFechaSugerida(LocalDate fechaSugerida) { this.fechaSugerida = fechaSugerida; }
    public Long getKilometrajeSugerido() { return kilometrajeSugerido; }
    public void setKilometrajeSugerido(Long kilometrajeSugerido) { this.kilometrajeSugerido = kilometrajeSugerido; }
}
