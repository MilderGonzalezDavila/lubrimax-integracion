...
public class ResumenHistorialLocal {
    ...
    public ResumenHistorialLocal(
            ...
            Long proximoKilometrajeSugerido) {
    ...
    public LocalDate getProximaFechaSugerida() {
        return proximaFechaSugerida;
    }

    public void setProximaFechaSugerida(LocalDate proximaFechaSugerida) {
        this.proximaFechaSugerida = proximaFechaSugerida;
    }

    public Long getProximoKilometrajeSugerido() {
        return proximoKilometrajeSugerido;
    }

    public void setProximoKilometrajeSugerido(Long proximoKilometrajeSugerido) {
        this.proximoKilometrajeSugerido = proximoKilometrajeSugerido;
    }
}
